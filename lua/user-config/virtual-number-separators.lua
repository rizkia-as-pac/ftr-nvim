-- source : https://gist.github.com/synic/618cc66f3516160dc14644e4ec20e734
...
local function format_number(number_str)
  ...
  -- Format integer part with spaces (now dots) every 3 digits from the right
  local formatted = int_part:reverse():gsub("(%d%d%d)", "%1_"):reverse():gsub("^%s+", "")
